...
namespace Telegram.MTProto {
    ...
    class TL {
        ...
        public static T Parse<T>(BinaryReader reader) {
            if(typeof(TLObject).IsAssignableFrom(typeof(T))) {
                ...
                if(!typeof(T).IsAssignableFrom(constructorType)) {
                    throw new Exception(String.Format("try to parse {0}, but incompatible type {1}", typeof(T).FullName, constructorType.FullName));
                }
        ...
        public static User userSelf (int id, string first_name, string last_name, string phone, UserProfilePhoto photo, UserStatus status, bool inactive) {
            return new UserSelfConstructor(id, first_name, last_name, phone, photo, status, inactive);
        }

        public static User userContact (int id, string first_name, string last_name, long access_hash, string phone, UserProfilePhoto photo, UserStatus status) {
            return new UserContactConstructor(id, first_name, last_name, access_hash, phone, photo, status);
        }

        public static User userRequest (int id, string first_name, string last_name, long access_hash, string phone, UserProfilePhoto photo, UserStatus status) {
            return new UserRequestConstructor(id, first_name, last_name, access_hash, phone, photo, status);
        }

        public static User userForeign (int id, string first_name, string last_name, long access_hash, UserProfilePhoto photo, UserStatus status) {
        ...
        public static Chat chat (int id, string title, ChatPhoto photo, int participants_count, int date, bool left, int version) {
        ...
        public static ChatFull chatFull (int id, ChatParticipants participants, Photo chat_photo, PeerNotifySettings notify_settings) {
        ...
        public static Message message (int id, int from_id, Peer to_id, bool output, bool unread, int date, string message, MessageMedia media) {
            return new MessageConstructor(id, from_id, to_id, output, unread, date, message, media);
        }

        public static Message messageForwarded (int id, int fwd_from_id, int fwd_date, int from_id, Peer to_id, bool output, bool unread, int date, string message, MessageMedia media) {
            return new MessageForwardedConstructor(id, fwd_from_id, fwd_date, from_id, to_id, output, unread, date, message, media);
        }

        public static Message messageService (int id, int from_id, Peer to_id, bool output, bool unread, int date, MessageAction action) {
        ...
        public static Photo photo (long id, long access_hash, int user_id, int date, string caption, GeoPoint geo, List<PhotoSize> sizes) {
        ...
        public static Video video (long id, long access_hash, int user_id, int date, string caption, int duration, int size, PhotoSize thumb, int dc_id, int w, int h) {
        ...
        public static UserFull userFull (User user, contacts_Link link, Photo profile_photo, PeerNotifySettings notify_settings, bool blocked, string real_first_name, string real_last_name) {
        ...
        public static messages_StatedMessages messages_statedMessages (List<Message> messages, List<Chat> chats, List<User> users, int pts, int seq) {
            return new Messages_statedMessagesConstructor(messages, chats, users, pts, seq);
        }

        public static messages_StatedMessage messages_statedMessage (Message message, List<Chat> chats, List<User> users, int pts, int seq) {
        ...
        public static Updates updateShortChatMessage (int id, int from_id, int chat_id, string message, int pts, int date, int seq) {
        ...
        public static messages_StatedMessages messages_statedMessagesLinks (List<Message> messages, List<Chat> chats, List<User> users, List<contacts_Link> links, int pts, int seq) {
            return new Messages_statedMessagesLinksConstructor(messages, chats, users, links, pts, seq);
        }

        public static messages_StatedMessage messages_statedMessageLink (Message message, List<Chat> chats, List<User> users, List<contacts_Link> links, int pts, int seq) {
            return new Messages_statedMessageLinkConstructor(message, chats, users, links, pts, seq);
        }

        public static messages_SentMessage messages_sentMessageLink (int id, int date, int pts, int seq, List<contacts_Link> links) {
        ...
        public static Chat geoChat (int id, long access_hash, string title, string address, string venue, GeoPoint geo, ChatPhoto photo, int participants_count, int date, bool checked_in, int version) {
            return new GeoChatConstructor(id, access_hash, title, address, venue, geo, photo, participants_count, date, checked_in, version);
        }
        ...
        public static GeoChatMessage geoChatMessage (int chat_id, int id, int from_id, int date, string message, MessageMedia media) {
        ...
        public static geochats_StatedMessage geochats_statedMessage (GeoChatMessage message, List<Chat> chats, List<User> users, int seq) {
            return new Geochats_statedMessageConstructor(message, chats, users, seq);
        }

        public static geochats_Located geochats_located (List<ChatLocated> results, List<GeoChatMessage> messages, List<Chat> chats, List<User> users) {
        ...
        public static geochats_Messages geochats_messagesSlice (int count, List<GeoChatMessage> messages, List<Chat> chats, List<User> users) {
        ...
        public static EncryptedChat encryptedChatRequested (int id, long access_hash, int date, int admin_id, int participant_id, byte[] g_a, byte[] nonce) {
            return new EncryptedChatRequestedConstructor(id, access_hash, date, admin_id, participant_id, g_a, nonce);
        }

        public static EncryptedChat encryptedChat (int id, long access_hash, int date, int admin_id, int participant_id, byte[] g_a_or_b, byte[] nonce, long key_fingerprint) {
        ...
        public static DecryptedMessage decryptedMessage (long random_id, byte[] random_bytes, string message, DecryptedMessageMedia media) {
            return new DecryptedMessageConstructor(random_id, random_bytes, message, media);
        }

        public static DecryptedMessage decryptedMessageService (long random_id, byte[] random_bytes, DecryptedMessageAction action) {
        ...
        public static DecryptedMessageMedia decryptedMessageMediaPhoto (byte[] thumb, int thumb_w, int thumb_h, int w, int h, int size, byte[] key, byte[] iv) {
            return new DecryptedMessageMediaPhotoConstructor(thumb, thumb_w, thumb_h, w, h, size, key, iv);
        }

        public static DecryptedMessageMedia decryptedMessageMediaVideo (byte[] thumb, int thumb_w, int thumb_h, int duration, int w, int h, int size, byte[] key, byte[] iv) {
        ...
        public static DecryptedMessageMedia decryptedMessageMediaContact (string phone_number, string first_name, string last_name, int user_id) {
        ...
        public static InputMedia inputMediaUploadedThumbDocument (InputFile file, InputFile thumb, string file_name, string mime_type) {
        ...
        public static DecryptedMessageMedia decryptedMessageMediaDocument (byte[] thumb, int thumb_w, int thumb_h, string file_name, string mime_type, int size, byte[] key, byte[] iv) {
        ...
        public static Document document (long id, long access_hash, int user_id, int date, string file_name, string mime_type, int size, PhotoSize thumb, int dc_id) {
    ...
    public class InputPeerEmptyConstructor : InputPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerEmpty;
            }
        }
    ...
    public class InputPeerSelfConstructor : InputPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerSelf;
            }
        }
    ...
    public class InputPeerContactConstructor : InputPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerContact;
            }
        }
    ...
    public class InputPeerForeignConstructor : InputPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerForeign;
            }
        }
    ...
    public class InputPeerChatConstructor : InputPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerChat;
            }
        }
    ...
    public class InputUserEmptyConstructor : InputUser {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputUserEmpty;
            }
        }
    ...
    public class InputUserSelfConstructor : InputUser {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputUserSelf;
            }
        }
    ...
    public class InputUserContactConstructor : InputUser {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputUserContact;
            }
        }
    ...
    public class InputUserForeignConstructor : InputUser {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputUserForeign;
            }
        }
    ...
    public class InputPhoneContactConstructor : InputContact {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPhoneContact;
            }
        }
    ...
    public class InputMediaEmptyConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaEmpty;
            }
        }
    ...
    public class InputMediaUploadedPhotoConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaUploadedPhoto;
            }
        }
    ...
    public class InputMediaPhotoConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaPhoto;
            }
        }
    ...
    public class InputMediaGeoPointConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaGeoPoint;
            }
        }
    ...
    public class InputMediaContactConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaContact;
            }
        }
    ...
    public class InputMediaUploadedVideoConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaUploadedVideo;
            }
        }
    ...
    public class InputMediaUploadedThumbVideoConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaUploadedThumbVideo;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(inputMediaUploadedThumbVideo file:{0} thumb:{1} duration:{2} w:{3} h:{4})", file, thumb, duration, w, h);
        }
    }
    ...
    public class InputMediaVideoConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaVideo;
            }
        }
    ...
    public class InputChatPhotoEmptyConstructor : InputChatPhoto {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputChatPhotoEmpty;
            }
        }
    ...
    public class InputChatUploadedPhotoConstructor : InputChatPhoto {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputChatUploadedPhoto;
            }
        }
    ...
    public class InputChatPhotoConstructor : InputChatPhoto {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputChatPhoto;
            }
        }
    ...
    public class InputGeoPointEmptyConstructor : InputGeoPoint {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputGeoPointEmpty;
            }
        }
    ...
    public class InputGeoPointConstructor : InputGeoPoint {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputGeoPoint;
            }
        }
    ...
    public class InputPhotoEmptyConstructor : InputPhoto {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPhotoEmpty;
            }
        }
    ...
    public class InputVideoEmptyConstructor : InputVideo {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputVideoEmpty;
            }
        }
    ...
    public class InputFileLocationConstructor : InputFileLocation {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputFileLocation;
            }
        }
    ...
    public class InputVideoFileLocationConstructor : InputFileLocation {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputVideoFileLocation;
            }
        }
    ...
    public class InputPhotoCropAutoConstructor : InputPhotoCrop {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPhotoCropAuto;
            }
        }
    ...
    public class InputPhotoCropConstructor : InputPhotoCrop {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPhotoCrop;
            }
        }
    ...
    public class InputAppEventConstructor : InputAppEvent {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputAppEvent;
            }
        }
    ...
    public class Storage_fileUnknownConstructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_fileUnknown;
            }
        }
    ...
    public class Storage_fileJpegConstructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_fileJpeg;
            }
        }
    ...
    public class Storage_fileGifConstructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_fileGif;
            }
        }
    ...
    public class Storage_filePngConstructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_filePng;
            }
        }
    ...
    public class Storage_fileMp3Constructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_fileMp3;
            }
        }
    ...
    public class Storage_fileMovConstructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_fileMov;
            }
        }
    ...
    public class Storage_filePartialConstructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_filePartial;
            }
        }
    ...
    public class Storage_fileMp4Constructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_fileMp4;
            }
        }
    ...
    public class Storage_fileWebpConstructor : storage_FileType {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.storage_fileWebp;
            }
        }
    ...
    public class FileLocationUnavailableConstructor : FileLocation {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.fileLocationUnavailable;
            }
        }
    ...
    public class FileLocationConstructor : FileLocation {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.fileLocation;
            }
        }
    ...
    public class UserSelfConstructor : User {
        ...
        public UserSelfConstructor(int id, string first_name, string last_name, string phone, UserProfilePhoto photo, UserStatus status, bool inactive) {
            this.id = id;
            this.first_name = first_name;
            this.last_name = last_name;
            this.phone = phone;
        ...
        public override string ToString() {
            return String.Format("(userSelf id:{0} first_name:'{1}' last_name:'{2}' phone:'{3}' photo:{4} status:{5} inactive:{6})", id, first_name, last_name, phone, photo, status, inactive);
        }
    }
    ...
    public class UserContactConstructor : User {
        ...
        public UserContactConstructor(int id, string first_name, string last_name, long access_hash, string phone, UserProfilePhoto photo, UserStatus status) {
            this.id = id;
            this.first_name = first_name;
            this.last_name = last_name;
            this.access_hash = access_hash;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userContact;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(userContact id:{0} first_name:'{1}' last_name:'{2}' access_hash:{3} phone:'{4}' photo:{5} status:{6})", id, first_name, last_name, access_hash, phone, photo, status);
        }
    }
    ...
    public class UserRequestConstructor : User {
        ...
        public UserRequestConstructor(int id, string first_name, string last_name, long access_hash, string phone, UserProfilePhoto photo, UserStatus status) {
            this.id = id;
            this.first_name = first_name;
            this.last_name = last_name;
            this.access_hash = access_hash;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userRequest;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(userRequest id:{0} first_name:'{1}' last_name:'{2}' access_hash:{3} phone:'{4}' photo:{5} status:{6})", id, first_name, last_name, access_hash, phone, photo, status);
        }
    }
    ...
    public class UserForeignConstructor : User {
        ...
        public UserForeignConstructor(int id, string first_name, string last_name, long access_hash, UserProfilePhoto photo, UserStatus status) {
            this.id = id;
            this.first_name = first_name;
            this.last_name = last_name;
            this.access_hash = access_hash;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userForeign;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(userForeign id:{0} first_name:'{1}' last_name:'{2}' access_hash:{3} photo:{4} status:{5})", id, first_name, last_name, access_hash, photo, status);
        }
    }
    ...
    public class UserDeletedConstructor : User {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userDeleted;
            }
        }
    ...
    public class UserProfilePhotoEmptyConstructor : UserProfilePhoto {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userProfilePhotoEmpty;
            }
        }
    ...
    public class UserProfilePhotoConstructor : UserProfilePhoto {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userProfilePhoto;
            }
        }
    ...
    public class UserStatusEmptyConstructor : UserStatus {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userStatusEmpty;
            }
        }
    ...
    public class UserStatusOnlineConstructor : UserStatus {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userStatusOnline;
            }
        }
    ...
    public class UserStatusOfflineConstructor : UserStatus {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.userStatusOffline;
            }
        }
    ...
    public class ChatConstructor : Chat {
        ...
        public override string ToString() {
            return String.Format("(chat id:{0} title:'{1}' photo:{2} participants_count:{3} date:{4} left:{5} version:{6})", id, title, photo, participants_count, date, left, version);
        }
    }
    ...
    public class ChatFullConstructor : ChatFull {
        ...
        public override string ToString() {
            return String.Format("(chatFull id:{0} participants:{1} chat_photo:{2} notify_settings:{3})", id, participants, chat_photo, notify_settings);
        }
    }
    ...
    public class ChatParticipantConstructor : ChatParticipant {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.chatParticipant;
            }
        }
    ...
    public class ChatParticipantsForbiddenConstructor : ChatParticipants {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.chatParticipantsForbidden;
            }
        }
    ...
    public class ChatParticipantsConstructor : ChatParticipants {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.chatParticipants;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(chatParticipants chat_id:{0} admin_id:{1} participants:{2} version:{3})", chat_id, admin_id, Serializers.VectorToString(participants), version);
        }
    }
    ...
    public class ChatPhotoEmptyConstructor : ChatPhoto {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.chatPhotoEmpty;
            }
        }
    ...
    public class MessageEmptyConstructor : Message {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageEmpty;
            }
        }
    ...
    public class MessageConstructor : Message {
        ...
        public MessageConstructor(int id, int from_id, Peer to_id, bool output, bool unread, int date, string message, MessageMedia media) {
            this.id = id;
        ...
        public override string ToString() {
            return String.Format("(message id:{0} from_id:{1} to_id:{2} out:{3} unread:{4} date:{5} message:'{6}' media:{7})", id, from_id, to_id, output, unread, date, message, media);
        }
    }
    ...
    public class MessageForwardedConstructor : Message {
        ...
        public MessageForwardedConstructor(int id, int fwd_from_id, int fwd_date, int from_id, Peer to_id, bool output, bool unread, int date, string message, MessageMedia media) {
            this.id = id;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageForwarded;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messageForwarded id:{0} fwd_from_id:{1} fwd_date:{2} from_id:{3} to_id:{4} out:{5} unread:{6} date:{7} message:'{8}' media:{9})", id, fwd_from_id, fwd_date, from_id, to_id, output, unread, date, message, media);
        }
    }
    ...
    public class MessageServiceConstructor : Message {
        ...
        public MessageServiceConstructor(int id, int from_id, Peer to_id, bool output, bool unread, int date, MessageAction action) {
            this.id = id;
            this.from_id = from_id;
            this.to_id = to_id;
            this.output = output;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageService;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messageService id:{0} from_id:{1} to_id:{2} out:{3} unread:{4} date:{5} action:{6})", id, from_id, to_id, output, unread, date, action);
        }
    }
    ...
    public class MessageMediaEmptyConstructor : MessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageMediaEmpty;
            }
        }
    ...
    public class MessageMediaVideoConstructor : MessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageMediaVideo;
            }
        }
    ...
    public class MessageMediaGeoConstructor : MessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageMediaGeo;
            }
        }
    ...
    public class MessageMediaContactConstructor : MessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageMediaContact;
            }
        }
    ...
    public class MessageMediaUnsupportedConstructor : MessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageMediaUnsupported;
            }
        }
    ...
    public class MessageActionEmptyConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionEmpty;
            }
        }
    ...
    public class MessageActionChatCreateConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionChatCreate;
            }
        }
    ...
    public class MessageActionChatEditTitleConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionChatEditTitle;
            }
        }
    ...
    public class MessageActionChatEditPhotoConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionChatEditPhoto;
            }
        }
    ...
    public class MessageActionChatDeletePhotoConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionChatDeletePhoto;
            }
        }
    ...
    public class MessageActionChatAddUserConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionChatAddUser;
            }
        }
    ...
    public class MessageActionChatDeleteUserConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionChatDeleteUser;
            }
        }
    ...
    public class PhotoConstructor : Photo {
        ...
        public PhotoConstructor(long id, long access_hash, int user_id, int date, string caption, GeoPoint geo, List<PhotoSize> sizes) {
            this.id = id;
            this.access_hash = access_hash;
            this.user_id = user_id;
            this.date = date;
        ...
        public override string ToString() {
            return String.Format("(photo id:{0} access_hash:{1} user_id:{2} date:{3} caption:'{4}' geo:{5} sizes:{6})", id, access_hash, user_id, date, caption, geo, Serializers.VectorToString(sizes));
        }
    }
    ...
    public class PhotoSizeEmptyConstructor : PhotoSize {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.photoSizeEmpty;
            }
        }
    ...
    public class PhotoCachedSizeConstructor : PhotoSize {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.photoCachedSize;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(photoCachedSize type:'{0}' location:{1} w:{2} h:{3} bytes:{4})", type, location, w, h, BitConverter.ToString(bytes));
        }
    }
    ...
    public class VideoConstructor : Video {
        ...
        public VideoConstructor(long id, long access_hash, int user_id, int date, string caption, int duration, int size, PhotoSize thumb, int dc_id, int w, int h) {
            this.id = id;
            this.access_hash = access_hash;
            this.user_id = user_id;
            this.date = date;
        ...
        public override string ToString() {
            return String.Format("(video id:{0} access_hash:{1} user_id:{2} date:{3} caption:'{4}' duration:{5} size:{6} thumb:{7} dc_id:{8} w:{9} h:{10})", id, access_hash, user_id, date, caption, duration, size, thumb, dc_id, w, h);
        }
    }
    ...
    public class GeoPointEmptyConstructor : GeoPoint {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geoPointEmpty;
            }
        }
    ...
    public class Auth_checkedPhoneConstructor : auth_CheckedPhone {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.auth_checkedPhone;
            }
        }
    ...
    public class Auth_sentCodeConstructor : auth_SentCode {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.auth_sentCode;
            }
        }
    ...
    public class Auth_authorizationConstructor : auth_Authorization {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.auth_authorization;
            }
        }
    ...
    public class Auth_exportedAuthorizationConstructor : auth_ExportedAuthorization {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.auth_exportedAuthorization;
            }
        }
    ...
    public class InputNotifyPeerConstructor : InputNotifyPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputNotifyPeer;
            }
        }
    ...
    public class InputNotifyUsersConstructor : InputNotifyPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputNotifyUsers;
            }
        }
    ...
    public class InputNotifyChatsConstructor : InputNotifyPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputNotifyChats;
            }
        }
    ...
    public class InputNotifyAllConstructor : InputNotifyPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputNotifyAll;
            }
        }
    ...
    public class InputPeerNotifyEventsEmptyConstructor : InputPeerNotifyEvents {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerNotifyEventsEmpty;
            }
        }
    ...
    public class InputPeerNotifyEventsAllConstructor : InputPeerNotifyEvents {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerNotifyEventsAll;
            }
        }
    ...
    public class InputPeerNotifySettingsConstructor : InputPeerNotifySettings {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputPeerNotifySettings;
            }
        }
    ...
    public class PeerNotifyEventsEmptyConstructor : PeerNotifyEvents {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.peerNotifyEventsEmpty;
            }
        }
    ...
    public class PeerNotifyEventsAllConstructor : PeerNotifyEvents {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.peerNotifyEventsAll;
            }
        }
    ...
    public class PeerNotifySettingsEmptyConstructor : PeerNotifySettings {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.peerNotifySettingsEmpty;
            }
        }
    ...
    public class PeerNotifySettingsConstructor : PeerNotifySettings {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.peerNotifySettings;
            }
        }
    ...
    public class WallPaperConstructor : WallPaper {
        ...
        public override string ToString() {
            return String.Format("(wallPaper id:{0} title:'{1}' sizes:{2} color:{3})", id, title, Serializers.VectorToString(sizes), color);
        }
    }
    ...
    public class UserFullConstructor : UserFull {
        ...
        public UserFullConstructor(User user, contacts_Link link, Photo profile_photo, PeerNotifySettings notify_settings, bool blocked, string real_first_name, string real_last_name) {
            this.user = user;
            this.link = link;
        ...
        public override string ToString() {
            return String.Format("(userFull user:{0} link:{1} profile_photo:{2} notify_settings:{3} blocked:{4} real_first_name:'{5}' real_last_name:'{6}')", user, link, profile_photo, notify_settings, blocked, real_first_name, real_last_name);
        }
    }
    ...
    public class ImportedContactConstructor : ImportedContact {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.importedContact;
            }
        }
    ...
    public class ContactBlockedConstructor : ContactBlocked {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contactBlocked;
            }
        }
    ...
    public class ContactFoundConstructor : ContactFound {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contactFound;
            }
        }
    ...
    public class ContactSuggestedConstructor : ContactSuggested {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contactSuggested;
            }
        }
    ...
    public class ContactStatusConstructor : ContactStatus {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contactStatus;
            }
        }
    ...
    public class ChatLocatedConstructor : ChatLocated {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.chatLocated;
            }
        }
    ...
    public class Contacts_foreignLinkUnknownConstructor : contacts_ForeignLink {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_foreignLinkUnknown;
            }
        }
    ...
    public class Contacts_foreignLinkRequestedConstructor : contacts_ForeignLink {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_foreignLinkRequested;
            }
        }
    ...
    public class Contacts_foreignLinkMutualConstructor : contacts_ForeignLink {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_foreignLinkMutual;
            }
        }
    ...
    public class Contacts_myLinkEmptyConstructor : contacts_MyLink {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_myLinkEmpty;
            }
        }
    ...
    public class Contacts_myLinkRequestedConstructor : contacts_MyLink {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_myLinkRequested;
            }
        }
    ...
    public class Contacts_myLinkContactConstructor : contacts_MyLink {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_myLinkContact;
            }
        }
    ...
    public class Contacts_linkConstructor : contacts_Link {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_link;
            }
        }
    ...
    public class Contacts_contactsConstructor : contacts_Contacts {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_contacts;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(contacts_contacts contacts:{0} users:{1})", Serializers.VectorToString(contacts), Serializers.VectorToString(users));
        }
    }
    ...
    public class Contacts_contactsNotModifiedConstructor : contacts_Contacts {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_contactsNotModified;
            }
        }
    ...
    public class Contacts_importedContactsConstructor : contacts_ImportedContacts {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_importedContacts;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(contacts_importedContacts imported:{0} users:{1})", Serializers.VectorToString(imported), Serializers.VectorToString(users));
        }
    }
    ...
    public class Contacts_blockedConstructor : contacts_Blocked {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_blocked;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(contacts_blocked blocked:{0} users:{1})", Serializers.VectorToString(blocked), Serializers.VectorToString(users));
        }
    }
    ...
    public class Contacts_blockedSliceConstructor : contacts_Blocked {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_blockedSlice;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(contacts_blockedSlice count:{0} blocked:{1} users:{2})", count, Serializers.VectorToString(blocked), Serializers.VectorToString(users));
        }
    }
    ...
    public class Contacts_foundConstructor : contacts_Found {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_found;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(contacts_found results:{0} users:{1})", Serializers.VectorToString(results), Serializers.VectorToString(users));
        }
    }
    ...
    public class Contacts_suggestedConstructor : contacts_Suggested {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.contacts_suggested;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(contacts_suggested results:{0} users:{1})", Serializers.VectorToString(results), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_dialogsConstructor : messages_Dialogs {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_dialogs;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_dialogs dialogs:{0} messages:{1} chats:{2} users:{3})", Serializers.VectorToString(dialogs), Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_dialogsSliceConstructor : messages_Dialogs {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_dialogsSlice;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_dialogsSlice count:{0} dialogs:{1} messages:{2} chats:{3} users:{4})", count, Serializers.VectorToString(dialogs), Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_messagesConstructor : messages_Messages {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_messages;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_messages messages:{0} chats:{1} users:{2})", Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_messagesSliceConstructor : messages_Messages {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_messagesSlice;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_messagesSlice count:{0} messages:{1} chats:{2} users:{3})", count, Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_messageEmptyConstructor : messages_Message {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_messageEmpty;
            }
        }
    ...
    public class Messages_messageConstructor : messages_Message {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_message;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_message message:{0} chats:{1} users:{2})", message, Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_statedMessagesConstructor : messages_StatedMessages {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_statedMessages;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_statedMessages messages:{0} chats:{1} users:{2} pts:{3} seq:{4})", Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users), pts, seq);
        }
    }
    ...
    public class Messages_statedMessageConstructor : messages_StatedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_statedMessage;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_statedMessage message:{0} chats:{1} users:{2} pts:{3} seq:{4})", message, Serializers.VectorToString(chats), Serializers.VectorToString(users), pts, seq);
        }
    }
    ...
    public class Messages_sentMessageConstructor : messages_SentMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_sentMessage;
            }
        }
    ...
    public class Messages_chatConstructor : messages_Chat {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_chat;
            }
        }
    ...
    public class Messages_chatsConstructor : messages_Chats {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_chats;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_chats chats:{0} users:{1})", Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_chatFullConstructor : messages_ChatFull {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_chatFull;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_chatFull full_chat:{0} chats:{1} users:{2})", full_chat, Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Messages_affectedHistoryConstructor : messages_AffectedHistory {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_affectedHistory;
            }
        }
    ...
    public class InputMessagesFilterEmptyConstructor : MessagesFilter {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMessagesFilterEmpty;
            }
        }
    ...
    public class InputMessagesFilterPhotosConstructor : MessagesFilter {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMessagesFilterPhotos;
            }
        }
    ...
    public class InputMessagesFilterVideoConstructor : MessagesFilter {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMessagesFilterVideo;
            }
        }
    ...
    public class InputMessagesFilterPhotoVideoConstructor : MessagesFilter {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMessagesFilterPhotoVideo;
            }
        }
    ...
    public class UpdateNewMessageConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateNewMessage;
            }
        }
    ...
    public class UpdateMessageIDConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateMessageID;
            }
        }
    ...
    public class UpdateReadMessagesConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateReadMessages;
            }
        }
    ...
    public class UpdateDeleteMessagesConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateDeleteMessages;
            }
        }
    ...
    public class UpdateRestoreMessagesConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateRestoreMessages;
            }
        }
    ...
    public class UpdateUserTypingConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateUserTyping;
            }
        }
    ...
    public class UpdateChatUserTypingConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateChatUserTyping;
            }
        }
    ...
    public class UpdateChatParticipantsConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateChatParticipants;
            }
        }
    ...
    public class UpdateUserStatusConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateUserStatus;
            }
        }
    ...
    public class UpdateUserNameConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateUserName;
            }
        }
    ...
    public class UpdateUserPhotoConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateUserPhoto;
            }
        }
    ...
    public class UpdateContactRegisteredConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateContactRegistered;
            }
        }
    ...
    public class UpdateContactLinkConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateContactLink;
            }
        }
    ...
    public class UpdateActivationConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateActivation;
            }
        }
    ...
    public class UpdateNewAuthorizationConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateNewAuthorization;
            }
        }
    ...
    public class Updates_stateConstructor : updates_State {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updates_state;
            }
        }
    ...
    public class Updates_differenceEmptyConstructor : updates_Difference {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updates_differenceEmpty;
            }
        }
    ...
    public class Updates_differenceConstructor : updates_Difference {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updates_difference;
            }
        }
        ...
        public override void Read(BinaryReader reader) {
            ...
            for(int new_encrypted_messages_index = 0; new_encrypted_messages_index < new_encrypted_messages_len; new_encrypted_messages_index++) {
        ...
        public override string ToString() {
            return String.Format("(updates_difference new_messages:{0} new_encrypted_messages:{1} other_updates:{2} chats:{3} users:{4} state:{5})", Serializers.VectorToString(new_messages), Serializers.VectorToString(new_encrypted_messages), Serializers.VectorToString(other_updates), Serializers.VectorToString(chats), Serializers.VectorToString(users), state);
        }
    }
    ...
    public class Updates_differenceSliceConstructor : updates_Difference {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updates_differenceSlice;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(updates_differenceSlice new_messages:{0} new_encrypted_messages:{1} other_updates:{2} chats:{3} users:{4} intermediate_state:{5})", Serializers.VectorToString(new_messages), Serializers.VectorToString(new_encrypted_messages), Serializers.VectorToString(other_updates), Serializers.VectorToString(chats), Serializers.VectorToString(users), intermediate_state);
        }
    }
    ...
    public class UpdatesTooLongConstructor : Updates {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updatesTooLong;
            }
        }
    ...
    public class UpdateShortMessageConstructor : Updates {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateShortMessage;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(updateShortMessage id:{0} from_id:{1} message:'{2}' pts:{3} date:{4} seq:{5})", id, from_id, message, pts, date, seq);
        }
    }
    ...
    public class UpdateShortChatMessageConstructor : Updates {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateShortChatMessage;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(updateShortChatMessage id:{0} from_id:{1} chat_id:{2} message:'{3}' pts:{4} date:{5} seq:{6})", id, from_id, chat_id, message, pts, date, seq);
        }
    }
    ...
    public class UpdateShortConstructor : Updates {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateShort;
            }
        }
    ...
    public class UpdatesCombinedConstructor : Updates {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updatesCombined;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(updatesCombined updates:{0} users:{1} chats:{2} date:{3} seq_start:{4} seq:{5})", Serializers.VectorToString(updates), Serializers.VectorToString(users), Serializers.VectorToString(chats), date, seq_start, seq);
        }
    }
    ...
    public class UpdatesConstructor : Updates {
        ...
        public override string ToString() {
            return String.Format("(updates updates:{0} users:{1} chats:{2} date:{3} seq:{4})", Serializers.VectorToString(updates), Serializers.VectorToString(users), Serializers.VectorToString(chats), date, seq);
        }
    }
    ...
    public class Photos_photosConstructor : photos_Photos {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.photos_photos;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(photos_photos photos:{0} users:{1})", Serializers.VectorToString(photos), Serializers.VectorToString(users));
        }
    }
    ...
    public class Photos_photosSliceConstructor : photos_Photos {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.photos_photosSlice;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(photos_photosSlice count:{0} photos:{1} users:{2})", count, Serializers.VectorToString(photos), Serializers.VectorToString(users));
        }
    }
    ...
    public class Photos_photoConstructor : photos_Photo {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.photos_photo;
            }
        }
    ...
    public class Upload_fileConstructor : upload_File {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.upload_file;
            }
        }
    ...
    public class ConfigConstructor : Config {
        ...
        public override string ToString() {
            return String.Format("(config date:{0} test_mode:{1} this_dc:{2} dc_options:{3} chat_size_max:{4})", date, test_mode, this_dc, Serializers.VectorToString(dc_options), chat_size_max);
        }
    }
    ...
    public class Help_appUpdateConstructor : help_AppUpdate {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.help_appUpdate;
            }
        }
    ...
    public class Help_noAppUpdateConstructor : help_AppUpdate {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.help_noAppUpdate;
            }
        }
    ...
    public class Help_inviteTextConstructor : help_InviteText {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.help_inviteText;
            }
        }
    ...
    public class Messages_statedMessagesLinksConstructor : messages_StatedMessages {
        ...
        public Messages_statedMessagesLinksConstructor(List<Message> messages, List<Chat> chats, List<User> users, List<contacts_Link> links, int pts, int seq) {
            this.messages = messages;
            this.chats = chats;
            this.users = users;
            this.links = links;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_statedMessagesLinks;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_statedMessagesLinks messages:{0} chats:{1} users:{2} links:{3} pts:{4} seq:{5})", Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users), Serializers.VectorToString(links), pts, seq);
        }
    }
    ...
    public class Messages_statedMessageLinkConstructor : messages_StatedMessage {
        ...
        public Messages_statedMessageLinkConstructor(Message message, List<Chat> chats, List<User> users, List<contacts_Link> links, int pts, int seq) {
            this.message = message;
            this.chats = chats;
            this.users = users;
            this.links = links;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_statedMessageLink;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_statedMessageLink message:{0} chats:{1} users:{2} links:{3} pts:{4} seq:{5})", message, Serializers.VectorToString(chats), Serializers.VectorToString(users), Serializers.VectorToString(links), pts, seq);
        }
    }
    ...
    public class Messages_sentMessageLinkConstructor : messages_SentMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_sentMessageLink;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_sentMessageLink id:{0} date:{1} pts:{2} seq:{3} links:{4})", id, date, pts, seq, Serializers.VectorToString(links));
        }
    }
    ...
    public class InputGeoChatConstructor : InputGeoChat {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputGeoChat;
            }
        }
    ...
    public class InputNotifyGeoChatPeerConstructor : InputNotifyPeer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputNotifyGeoChatPeer;
            }
        }
    ...
    public class GeoChatConstructor : Chat {
        ...
        public GeoChatConstructor(int id, long access_hash, string title, string address, string venue, GeoPoint geo, ChatPhoto photo, int participants_count, int date, bool checked_in, int version) {
            this.id = id;
            this.access_hash = access_hash;
            this.title = title;
        ...
        public override string ToString() {
            return String.Format("(geoChat id:{0} access_hash:{1} title:'{2}' address:'{3}' venue:'{4}' geo:{5} photo:{6} participants_count:{7} date:{8} checked_in:{9} version:{10})", id, access_hash, title, address, venue, geo, photo, participants_count, date, checked_in, version);
        }
    }
    ...
    public class GeoChatMessageEmptyConstructor : GeoChatMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geoChatMessageEmpty;
            }
        }
    ...
    public class GeoChatMessageConstructor : GeoChatMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geoChatMessage;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(geoChatMessage chat_id:{0} id:{1} from_id:{2} date:{3} message:'{4}' media:{5})", chat_id, id, from_id, date, message, media);
        }
    }
    ...
    public class GeoChatMessageServiceConstructor : GeoChatMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geoChatMessageService;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(geoChatMessageService chat_id:{0} id:{1} from_id:{2} date:{3} action:{4})", chat_id, id, from_id, date, action);
        }
    }
    ...
    public class Geochats_statedMessageConstructor : geochats_StatedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geochats_statedMessage;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(geochats_statedMessage message:{0} chats:{1} users:{2} seq:{3})", message, Serializers.VectorToString(chats), Serializers.VectorToString(users), seq);
        }
    }
    ...
    public class Geochats_locatedConstructor : geochats_Located {
        ...
        public Geochats_locatedConstructor(List<ChatLocated> results, List<GeoChatMessage> messages, List<Chat> chats, List<User> users) {
            this.results = results;
            this.messages = messages;
            this.chats = chats;
            this.users = users;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geochats_located;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(geochats_located results:{0} messages:{1} chats:{2} users:{3})", Serializers.VectorToString(results), Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Geochats_messagesConstructor : geochats_Messages {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geochats_messages;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(geochats_messages messages:{0} chats:{1} users:{2})", Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class Geochats_messagesSliceConstructor : geochats_Messages {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.geochats_messagesSlice;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(geochats_messagesSlice count:{0} messages:{1} chats:{2} users:{3})", count, Serializers.VectorToString(messages), Serializers.VectorToString(chats), Serializers.VectorToString(users));
        }
    }
    ...
    public class MessageActionGeoChatCreateConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionGeoChatCreate;
            }
        }
    ...
    public class MessageActionGeoChatCheckinConstructor : MessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageActionGeoChatCheckin;
            }
        }
    ...
    public class UpdateNewGeoChatMessageConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateNewGeoChatMessage;
            }
        }
    ...
    public class WallPaperSolidConstructor : WallPaper {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.wallPaperSolid;
            }
        }
    ...
    public class UpdateNewEncryptedMessageConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateNewEncryptedMessage;
            }
        }
    ...
    public class UpdateEncryptedChatTypingConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateEncryptedChatTyping;
            }
        }
    ...
    public class UpdateEncryptionConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateEncryption;
            }
        }
    ...
    public class UpdateEncryptedMessagesReadConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateEncryptedMessagesRead;
            }
        }
    ...
    public class EncryptedChatEmptyConstructor : EncryptedChat {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedChatEmpty;
            }
        }
    ...
    public class EncryptedChatWaitingConstructor : EncryptedChat {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedChatWaiting;
            }
        }
    ...
    public class EncryptedChatRequestedConstructor : EncryptedChat {
        ...
        public EncryptedChatRequestedConstructor(int id, long access_hash, int date, int admin_id, int participant_id, byte[] g_a, byte[] nonce) {
            this.id = id;
            this.access_hash = access_hash;
            this.date = date;
            this.admin_id = admin_id;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedChatRequested;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(encryptedChatRequested id:{0} access_hash:{1} date:{2} admin_id:{3} participant_id:{4} g_a:{5} nonce:{6})", id, access_hash, date, admin_id, participant_id, BitConverter.ToString(g_a), BitConverter.ToString(nonce));
        }
    }
    ...
    public class EncryptedChatConstructor : EncryptedChat {
        ...
        public EncryptedChatConstructor(int id, long access_hash, int date, int admin_id, int participant_id, byte[] g_a_or_b, byte[] nonce, long key_fingerprint) {
            this.id = id;
            this.access_hash = access_hash;
            this.date = date;
            this.admin_id = admin_id;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedChat;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(encryptedChat id:{0} access_hash:{1} date:{2} admin_id:{3} participant_id:{4} g_a_or_b:{5} nonce:{6} key_fingerprint:{7})", id, access_hash, date, admin_id, participant_id, BitConverter.ToString(g_a_or_b), BitConverter.ToString(nonce), key_fingerprint);
        }
    }
    ...
    public class EncryptedChatDiscardedConstructor : EncryptedChat {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedChatDiscarded;
            }
        }
    ...
    public class InputEncryptedChatConstructor : InputEncryptedChat {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputEncryptedChat;
            }
        }
    ...
    public class EncryptedFileEmptyConstructor : EncryptedFile {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedFileEmpty;
            }
        }
    ...
    public class EncryptedFileConstructor : EncryptedFile {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedFile;
            }
        }
    ...
    public class InputEncryptedFileEmptyConstructor : InputEncryptedFile {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputEncryptedFileEmpty;
            }
        }
    ...
    public class InputEncryptedFileUploadedConstructor : InputEncryptedFile {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputEncryptedFileUploaded;
            }
        }
    ...
    public class InputEncryptedFileConstructor : InputEncryptedFile {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputEncryptedFile;
            }
        }
    ...
    public class InputEncryptedFileLocationConstructor : InputFileLocation {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputEncryptedFileLocation;
            }
        }
    ...
    public class EncryptedMessageConstructor : EncryptedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedMessage;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(encryptedMessage random_id:{0} chat_id:{1} date:{2} bytes:{3} file:{4})", random_id, chat_id, date, BitConverter.ToString(bytes), file);
        }
    }
    ...
    public class EncryptedMessageServiceConstructor : EncryptedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.encryptedMessageService;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(encryptedMessageService random_id:{0} chat_id:{1} date:{2} bytes:{3})", random_id, chat_id, date, BitConverter.ToString(bytes));
        }
    }
    ...
    public class DecryptedMessageLayerConstructor : DecryptedMessageLayer {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageLayer;
            }
        }
    ...
    public class DecryptedMessageConstructor : DecryptedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessage;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(decryptedMessage random_id:{0} random_bytes:{1} message:'{2}' media:{3})", random_id, BitConverter.ToString(random_bytes), message, media);
        }
    }
    ...
    public class DecryptedMessageServiceConstructor : DecryptedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageService;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(decryptedMessageService random_id:{0} random_bytes:{1} action:{2})", random_id, BitConverter.ToString(random_bytes), action);
        }
    }
    ...
    public class DecryptedMessageMediaEmptyConstructor : DecryptedMessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageMediaEmpty;
            }
        }
    ...
    public class DecryptedMessageMediaPhotoConstructor : DecryptedMessageMedia {
        ...
        public DecryptedMessageMediaPhotoConstructor(byte[] thumb, int thumb_w, int thumb_h, int w, int h, int size, byte[] key, byte[] iv) {
            this.thumb = thumb;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageMediaPhoto;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(decryptedMessageMediaPhoto thumb:{0} thumb_w:{1} thumb_h:{2} w:{3} h:{4} size:{5} key:{6} iv:{7})", BitConverter.ToString(thumb), thumb_w, thumb_h, w, h, size, BitConverter.ToString(key), BitConverter.ToString(iv));
        }
    }
    ...
    public class DecryptedMessageMediaVideoConstructor : DecryptedMessageMedia {
        ...
        public DecryptedMessageMediaVideoConstructor(byte[] thumb, int thumb_w, int thumb_h, int duration, int w, int h, int size, byte[] key, byte[] iv) {
            this.thumb = thumb;
            this.thumb_w = thumb_w;
            this.thumb_h = thumb_h;
            this.duration = duration;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageMediaVideo;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(decryptedMessageMediaVideo thumb:{0} thumb_w:{1} thumb_h:{2} duration:{3} w:{4} h:{5} size:{6} key:{7} iv:{8})", BitConverter.ToString(thumb), thumb_w, thumb_h, duration, w, h, size, BitConverter.ToString(key), BitConverter.ToString(iv));
        }
    }
    ...
    public class DecryptedMessageMediaGeoPointConstructor : DecryptedMessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageMediaGeoPoint;
            }
        }
    ...
    public class DecryptedMessageMediaContactConstructor : DecryptedMessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageMediaContact;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(decryptedMessageMediaContact phone_number:'{0}' first_name:'{1}' last_name:'{2}' user_id:{3})", phone_number, first_name, last_name, user_id);
        }
    }
    ...
    public class DecryptedMessageActionSetMessageTTLConstructor : DecryptedMessageAction {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageActionSetMessageTTL;
            }
        }
    ...
    public class Messages_dhConfigNotModifiedConstructor : messages_DhConfig {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_dhConfigNotModified;
            }
        }
    ...
    public class Messages_dhConfigConstructor : messages_DhConfig {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_dhConfig;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(messages_dhConfig g:{0} p:{1} version:{2} random:{3})", g, BitConverter.ToString(p), version, BitConverter.ToString(random));
        }
    }
    ...
    public class Messages_sentEncryptedMessageConstructor : messages_SentEncryptedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_sentEncryptedMessage;
            }
        }
    ...
    public class Messages_sentEncryptedFileConstructor : messages_SentEncryptedMessage {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messages_sentEncryptedFile;
            }
        }
    ...
    public class InputFileBigConstructor : InputFile {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputFileBig;
            }
        }
    ...
    public class InputEncryptedFileBigUploadedConstructor : InputEncryptedFile {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputEncryptedFileBigUploaded;
            }
        }
    ...
    public class UpdateChatParticipantAddConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateChatParticipantAdd;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(updateChatParticipantAdd chat_id:{0} user_id:{1} inviter_id:{2} version:{3})", chat_id, user_id, inviter_id, version);
        }
    }
    ...
    public class UpdateChatParticipantDeleteConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateChatParticipantDelete;
            }
        }
    ...
    public class UpdateDcOptionsConstructor : Update {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.updateDcOptions;
            }
        }
    ...
    public class InputMediaUploadedAudioConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaUploadedAudio;
            }
        }
    ...
    public class InputMediaAudioConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaAudio;
            }
        }
    ...
    public class InputMediaUploadedDocumentConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaUploadedDocument;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(inputMediaUploadedDocument file:{0} file_name:'{1}' mime_type:'{2}')", file, file_name, mime_type);
        }
    }
    ...
    public class InputMediaUploadedThumbDocumentConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaUploadedThumbDocument;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(inputMediaUploadedThumbDocument file:{0} thumb:{1} file_name:'{2}' mime_type:'{3}')", file, thumb, file_name, mime_type);
        }
    }
    ...
    public class InputMediaDocumentConstructor : InputMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputMediaDocument;
            }
        }
    ...
    public class MessageMediaAudioConstructor : MessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.messageMediaAudio;
            }
        }
    ...
    public class InputAudioEmptyConstructor : InputAudio {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputAudioEmpty;
            }
        }
    ...
    public class InputDocumentEmptyConstructor : InputDocument {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputDocumentEmpty;
            }
        }
    ...
    public class InputDocumentConstructor : InputDocument {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputDocument;
            }
        }
    ...
    public class InputAudioFileLocationConstructor : InputFileLocation {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputAudioFileLocation;
            }
        }
    ...
    public class InputDocumentFileLocationConstructor : InputFileLocation {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.inputDocumentFileLocation;
            }
        }
    ...
    public class DecryptedMessageMediaDocumentConstructor : DecryptedMessageMedia {
        ...
        public DecryptedMessageMediaDocumentConstructor(byte[] thumb, int thumb_w, int thumb_h, string file_name, string mime_type, int size, byte[] key, byte[] iv) {
            this.thumb = thumb;
            this.thumb_w = thumb_w;
            this.thumb_h = thumb_h;
            this.file_name = file_name;
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageMediaDocument;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(decryptedMessageMediaDocument thumb:{0} thumb_w:{1} thumb_h:{2} file_name:'{3}' mime_type:'{4}' size:{5} key:{6} iv:{7})", BitConverter.ToString(thumb), thumb_w, thumb_h, file_name, mime_type, size, BitConverter.ToString(key), BitConverter.ToString(iv));
        }
    }
    ...
    public class DecryptedMessageMediaAudioConstructor : DecryptedMessageMedia {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.decryptedMessageMediaAudio;
            }
        }
        ...
        public override string ToString() {
            return String.Format("(decryptedMessageMediaAudio duration:{0} size:{1} key:{2} iv:{3})", duration, size, BitConverter.ToString(key), BitConverter.ToString(iv));
        }
    }
    ...
    public class AudioConstructor : Audio {
        ...
        public override string ToString() {
            return String.Format("(audio id:{0} access_hash:{1} user_id:{2} date:{3} duration:{4} size:{5} dc_id:{6})", id, access_hash, user_id, date, duration, size, dc_id);
        }
    }
    ...
    public class DocumentEmptyConstructor : Document {
        ...
        public override Constructor Constructor {
            get {
                return Constructor.documentEmpty;
            }
        }
    ...
    public class DocumentConstructor : Document {
        ...
        public DocumentConstructor(long id, long access_hash, int user_id, int date, string file_name, string mime_type, int size, PhotoSize thumb, int dc_id) {
            this.id = id;
            this.access_hash = access_hash;
            this.user_id = user_id;
            this.date = date;
        ...
        public override string ToString() {
            return String.Format("(document id:{0} access_hash:{1} user_id:{2} date:{3} file_name:'{4}' mime_type:'{5}' size:{6} thumb:{7} dc_id:{8})", id, access_hash, user_id, date, file_name, mime_type, size, thumb, dc_id);
        }
    }
    ...
    public class TLApi {
        ...
        public async Task<auth_SentCode> auth_sendCode(string phone_number, int sms_type, int api_id, string api_hash, string lang_code) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                Serializers.String.write(writer, phone_number);
                writer.Write(sms_type);
                writer.Write(api_id);
                Serializers.String.write(writer, api_hash);
                Serializers.String.write(writer, lang_code);
                request = memory.ToArray();
            }
        ...
        public async Task<auth_Authorization> auth_signUp(string phone_number, string phone_code_hash, string phone_code, string first_name, string last_name) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                Serializers.String.write(writer, phone_number);
                Serializers.String.write(writer, phone_code_hash);
                Serializers.String.write(writer, phone_code);
        ...
        public async Task<bool> auth_sendInvites(List<string> phone_numbers, string message) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                writer.Write(0x1cb5c415);
                writer.Write(phone_numbers.Count);
                foreach(string phone_numbers_element in phone_numbers) {
        ...
        public async Task<bool> account_registerDevice(int token_type, string token, string device_model, string system_version, string app_version, bool app_sandbox, string lang_code) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                Serializers.String.write(writer, token);
        ...
        public async Task<List<User>> users_getUsers(List<InputUser> id) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                foreach(InputUser id_element in id) {
        ...
        public async Task<contacts_ImportedContacts> contacts_importContacts(List<InputContact> contacts, bool replace) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                foreach(InputContact contacts_element in contacts) {
                    contacts_element.Write(writer);
                }
        ...
        public async Task<contacts_Found> contacts_search(string q, int limit) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                Serializers.String.write(writer, q);
                writer.Write(limit);
                request = memory.ToArray();
            }
        ...
        public async Task<messages_Messages> messages_search(InputPeer peer, string q, MessagesFilter filter, int min_date, int max_date, int offset, int max_id, int limit) {
            ...
            using (MemoryStream memory = new MemoryStream())
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                writer.Write(0x07e9f2ab);
                peer.Write(writer);
                Serializers.String.write(writer, q);
                filter.Write(writer);
                writer.Write(min_date);
        ...
        public async Task<bool> help_saveAppLog(List<InputAppEvent> events) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                foreach(InputAppEvent events_element in events) {
        ...
        public async Task<messages_StatedMessages> messages_sendBroadcast(List<InputUser> contacts, string message, InputMedia media) {
            ...
            using (MemoryStream memory = new MemoryStream())
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                writer.Write(0x41bb0972);
                writer.Write(0x1cb5c415);
                writer.Write(contacts.Count);
                foreach(InputUser contacts_element in contacts) {
                    contacts_element.Write(writer);
                }
                Serializers.String.write(writer, message);
                media.Write(writer);
        ...
        public async Task<EncryptedChat> messages_acceptEncryption(InputEncryptedChat peer, byte[] g_b, long key_fingerprint) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                peer.Write(writer);
                Serializers.Bytes.write(writer, g_b);
        ...
        public async Task<messages_SentEncryptedMessage> messages_sendEncrypted(InputEncryptedChat peer, long random_id, byte[] data) {
            ...
            using(BinaryWriter writer = new BinaryWriter(memory)) {
                ...
                peer.Write(writer);
                writer.Write(random_id);
                Serializers.Bytes.write(writer, data);
                request = memory.ToArray();
            }
